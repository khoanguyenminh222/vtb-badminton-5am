...
export function getSheetsClient() {
  ...
  console.log("[Sheets] email được thiết lập:", !!email, "| kóa bắt đầu bằng:", privateKey.slice(0, 27));
 ...
 * @param {number} amount    - Số tiền ghi nhận cho mỗi thành viên
 */
export async function recordPayments(sheetUrl, dateStr, members, amount) {
